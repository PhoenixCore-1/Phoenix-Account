...
-- Canonical development/test schema.
-- Account 360 stores projections, references and timeline context only.
-- Financial, CRM, Sales, Inventory and Procurement system-of-record data remains external.
